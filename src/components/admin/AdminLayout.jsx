  ...
  return (
    <div className="h-screen bg-brand-cream flex overflow-hidden">
      ...
      <aside className="hidden lg:flex flex-col w-80 h-full p-6">
        <div className="h-full flex flex-col bg-brand-brown rounded-[2.5rem] shadow-2xl overflow-hidden border border-white/5">
          {/* Sidebar Header */}
      ...
      <div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden">
        {/* Simple Top Bar */}
        <header className="h-20 flex items-center justify-between px-10 bg-white/60 backdrop-blur-xl border-b border-brand-brown/5">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-[10px] font-black text-brand-brown/20 uppercase tracking-[0.5em]">
        ...
        {/* Page Content */}
        <main className="flex-1 overflow-y-auto px-10 py-10 bg-brand-cream/30">
